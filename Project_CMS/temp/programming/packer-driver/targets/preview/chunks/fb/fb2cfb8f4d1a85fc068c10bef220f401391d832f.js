        ...
        UploadFile(node) {
          if (cc.sys.isBrowser) {
            ...
            ipFile.addEventListener("change", () => {
              ...
              formdata.append("Item", ipFile.files[0], ipFile.files[0].name); // formdata.append("ClassItem", node.name);
        ...
        setImage(remoteUrl, node) {
          ...
          if (typefile == "png" || typefile == "jpg") {
            assetManager.loadRemote(remoteUrl, (err, imageAsset) => {
              var spr = find("Img", this.nodeupload);
              console.log(spr);
...
//# sourceMappingURL=fb2cfb8f4d1a85fc068c10bef220f401391d832f.js.map