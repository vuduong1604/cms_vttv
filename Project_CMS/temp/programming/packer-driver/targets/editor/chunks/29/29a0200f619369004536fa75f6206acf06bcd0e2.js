      ...
      _export("Game1_4", Game1_4 = (_dec = ccclass('Game1_4'), _dec2 = property(Node), _dec3 = property(SpriteFrame), _dec4 = property(Node), _dec(_class = (_class2 = class Game1_4 extends Component {
        ...
        setImage(remoteUrl) {
          ...
          if (typefile == "mp3") {
            ...
            textlabel.getComponent(Label).string = remoteUrl;
            this.enableSoundSprite.active = true; // find("Sound", this.nodeSave).getComponent(Sprite).spriteFrame =
...
//# sourceMappingURL=29a0200f619369004536fa75f6206acf06bcd0e2.js.map