System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game1_4", Game1_4 = (_dec = ccclass('Game1_4'), _dec2 = property(Node), _dec3 = property(SpriteFrame), _dec4 = property(Node), _dec(_class = (_class2 = class Game1_4 extends Component {
        constructor(...args) {
          super(...args);
          ...
          if (cc.sys.isBrowser) {
            ...
            ipFile.addEventListener("change", () => {
              ...
              fetch("http://localhost:64457/Api/UploadFile", requestOptions).then(response => response.text()).then(result => {
                ...
                let url = JSON.parse(result).url; //   console.log(this.nodeSave.uuid);
        ...
        setImage(remoteUrl) {
          ...
          if (typefile == "mp3") {
            ...
            textlabel.getComponent(Label).string = remoteUrl; // find("Sound", this.nodeSave).getComponent(Sprite).spriteFrame =
            //     this.enableSoundSprite;

            this.enableSoundSprite.active;
          }
        }
...
//# sourceMappingURL=c41fb1f8f0c6bdf23a1937c30d3ec423816109d1.js.map