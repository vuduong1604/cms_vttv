System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, assetManager, SpriteFrame, Texture2D, find, Sprite, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, Game1_4;
      ...
      _export("Game1_4", Game1_4 = (_dec = ccclass('Game1_4'), _dec2 = property(Node), _dec3 = property(SpriteFrame), _dec4 = property(SpriteFrame), _dec(_class = (_class2 = class Game1_4 extends Component {
        ...
        setImage(remoteUrl) {
          assetManager.loadRemote(remoteUrl, (err, imageAsset) => {
            var spr = find("Label", this.nodeSave);
            console.log(spr);
...
//# sourceMappingURL=62741ee89b067a7babdde6856b49e12905fb26de.js.map